 ...
 * }
 * @psalm-type AuthenticationPolicyConfig = array{
 *     enrollment_path?: scalar|Param|null, // Le chemin où le verrou renvoie ceux qui n'ont pas posé ce que la politique exige. // Default: null
 *     settings?: array<string, array{ // Default: []
 *         ceiling?: mixed, // Le point de départ : un booléen, ou un nombre de secondes pour une durée. Absent, c'est la valeur la plus permissive — ce qu'une passe refuse pour une durée déléguée. // Default: null
 *         delegated_to?: list<scalar|Param|null>,
 *     }>,
 * }
